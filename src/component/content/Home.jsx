...
function Home() {
    ...
    return (
        <>
            <div id="main" className=" relative  flex justify-center items-center h-[100vh] md:h-screen w-full bg-[url('https://images.unsplash.com/photo-1558591710-4b4a1ae0f04d?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NDN8fHBvcnRmb2xpb3xlbnwwfHwwfHx8MA%3D%3D')] bg-cover ">
